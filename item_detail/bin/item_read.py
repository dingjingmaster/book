...
def parse_log(x):
    ...
    appUdid = phoneUdid
    # 滤除没有书籍 id 的日志信息
    if len(gid) <= 4 or appUdid == '' or entrance != u'书架' or curChap == ""  or (not is_num(curChap)):
        return ""
...
if __name__ == '__main__':
    ...
    sc = spark_init("spark://qd01-tech2-spark001:7077,qd01-tech2-spark002:7077", "20g", "item_read")
    #sc = spark_init("local", "20g", "item_read")
